...
ping -i0.1 -c100 192.168.56.106 | tee direct-ping.txt
...
ping -i0.1 -c100 10.20.0.2 | tee udp-ping.txt
...
ping -i0.1 -c100 10.20.0.2 | tee dns-ping.txt
...
ping -i0.1 -c100 10.20.0.2 | tee icmp-ping.txt
```
